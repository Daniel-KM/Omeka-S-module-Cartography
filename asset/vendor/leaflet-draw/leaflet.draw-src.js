...
L.EditToolbar.Edit = L.Handler.extend({
	...
	_enableLayerEdit: function (e) {
		...
		// Add this event to handle for specific layer editable or not
		// ex: editing permission
		// if can't edit, don't add the click event
		var dataBeforeEnableEdit = {
			control: this,
			layer: layer,
			_dataFromOutside: {forceExit: false}
		};
		this._map.fire('leafletDraw:beforeEnableEdit', dataBeforeEnableEdit);
		// Add a function for the event controlled from outside to force exit
		if (dataBeforeEnableEdit._dataFromOutside.forceExit === true) {
			return;
		}
...
L.EditToolbar.Delete = L.Handler.extend({
	...
	_enableLayerDelete: function (e) {
		...
		// Add this event to handle for specific layer deletable or not
		// ex: deleting permission
		// if can't delete, don't add the click event
		var dataBeforeEnableDelete = {
			control: this,
			layer: layer,
			_dataFromOutside: {forceExit: false}
		};
		this._map.fire('leafletDraw:beforeEnableDelete', dataBeforeEnableDelete);
		// Add a function for the event controlled from outside to force exit
		if (dataBeforeEnableDelete._dataFromOutside.forceExit === true) {
			return;
		}
